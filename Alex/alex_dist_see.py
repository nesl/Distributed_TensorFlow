...
cluster = tf.train.ClusterSpec({"DSGraph":["172.17.5.168:2223","172.17.100.219:2223","172.17.100.182:2223"]})
...
with tf.device("/job:DSGraph/task:2"):
  #conv2
...
with tf.device("/job:DSGraph/task:1"):
  #maxpool5
